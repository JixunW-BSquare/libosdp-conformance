...
void skip_conformance_tests(
    OSDP_CONTEXT* ctx,
    OSDP_INTEROP_ASSESSMENT* oconf) { /* skip_conformance_tests */
...
char* conformance_status(unsigned char cstat) { /* conformance_status */
...
void dump_conformance(OSDP_CONTEXT* ctx,
                      OSDP_INTEROP_ASSESSMENT* oconf) { /* dump_conformance */
...
int osdp_report(OSDP_CONTEXT* ctx) { /* osdp_report */
...
int osdp_test_set_status(char* test,
                         int test_status) { /* osdp_test_set_status */
