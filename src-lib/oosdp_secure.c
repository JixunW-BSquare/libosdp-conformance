...
void osdp_create_keys(OSDP_CONTEXT* ctx) { /* osdp_create_keys */
...
int osdp_build_secure_message(
    ...
    unsigned char* sec_blk) { /* osdp_build_secure_mesage */
...
void osdp_create_client_cryptogram(
    OSDP_CONTEXT* ctx,
    OSDP_SC_CCRYPT* ccrypt_response) { /* osdp_create_client_cryptogram */
...
int osdp_get_key_slot(OSDP_CONTEXT* ctx,
                      OSDP_MSG* msg,
                      int* returned_key_slot) { /* osdp_get_key_slot */
...
void osdp_reset_secure_channel(
    OSDP_CONTEXT* ctx) { /* osdp_reset_secure_channel */
...
int osdp_setup_scbk(OSDP_CONTEXT* ctx, OSDP_MSG* msg) { /* osdp_setup_scbk */
...
int send_secure_message(OSDP_CONTEXT* ctx,
                        int command,
                        int dest_addr,
                        int* current_length,
                        int data_length,
                        ...
                        int sec_block_type,
                        int sec_block_length,
                        unsigned char* sec_blk) { /* send_secure_message */
