...
int action_osdp_CCRYPT(OSDP_CONTEXT* ctx,
                       OSDP_MSG* msg) { /* action_osdp_CCRYPT */
...
int action_osdp_MFG(OSDP_CONTEXT* ctx, OSDP_MSG* msg) { /* action_osdp_MFG */
...
int action_osdp_OUT(OSDP_CONTEXT* ctx, OSDP_MSG* msg) { /* action_osdp_OUT */
...
int action_osdp_RAW(OSDP_CONTEXT* ctx, OSDP_MSG* msg) { /* action_osdp_RAW */
...
int action_osdp_RMAC_I(OSDP_CONTEXT* ctx,
                       OSDP_MSG* msg) { /* action_osdp_RMAC_I */
...
int action_osdp_RSTAT(OSDP_CONTEXT* ctx,
                      OSDP_MSG* msg) { /* action_osdp_RSTAT */
...
int action_osdp_SCRYPT(OSDP_CONTEXT* ctx,
                       OSDP_MSG* msg) { /* action_osdp_SCRYPT */
...
int action_osdp_TEXT(OSDP_CONTEXT* ctx, OSDP_MSG* msg) { /* action_osdp_TEXT */
