...
int background(OSDP_CONTEXT* context) { /* background */
...
*/
void end_element(void* data, const char* el) { /* end_element */
...
int fasc_n_75_to_string(char* s, long int* sample_1) { /* fasc_n_75_to_string */
...
int next_sequence(OSDP_CONTEXT* ctx) { /* next_sequence */
...
int osdp_timeout(OSDP_CONTEXT* ctx,
                 struct timespec* last_time_ex) { /* osdp_timeout */
...
int parse_json(OSDP_CONTEXT* ctx) { /* parse_json */
...
int read_config(OSDP_CONTEXT* ctx) { /* read_config */
...
int send_bio_read_template(OSDP_CONTEXT* ctx) { /* send_bio_read_template */
...
int send_message(OSDP_CONTEXT* context,
                 ...
                 int* current_length,
                 int data_length,
                 unsigned char* data) { /* send_message */
