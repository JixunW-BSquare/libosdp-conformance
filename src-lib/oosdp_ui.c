...
{ /* process_command */
    ...
    if ((!processed) && (context->current_menu EQUALS OSDP_MENU_TOP)) {
        ...
        case OSDP_CMDB_BUZZ: {
            ...
            current_length = 0;
            status = send_message(context,
                OSDP_BUZ, p_card.addr, &current_length, sizeof(buzzer_control),
        ...
        case OSDP_CMDB_KEYPAD: {
            ...
            status = send_message(context,
                OSDP_KEYPAD, p_card.addr, &current_length, sizeof(keypad_message) - 1,
        ...
        case OSDP_CMDB_LED: {
            ...
            current_length = 0;
            status = send_message(context,
                OSDP_LED, p_card.addr, &current_length, sizeof(led_control_message),
