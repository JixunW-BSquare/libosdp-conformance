...
int osdp_check_command_reply(int role,
                             int command,
                             OSDP_MSG* m,
                             char* tlogmsg2) { /* osdp_check_command_reply */
...
int osdp_parse_message(OSDP_CONTEXT* context,
                       int role,
                       OSDP_MSG* m,
                       OSDP_HDR* returned_hdr) { /* parse_message */
...
int monitor_osdp_message(OSDP_CONTEXT* context,
                         OSDP_MSG* msg) { /* monitor_osdp_message */
...
int process_osdp_message(OSDP_CONTEXT* context,
                         OSDP_MSG* msg) { /* process_osdp_message */
